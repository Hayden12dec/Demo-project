    ...
    <>
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: '1.05rem', letterSpacing: '-0.01em', display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>
              AI Examination Proctoring System (Mid-Term Evaluation)
            </div>
          </div>
        </div>
