...
class ExamService:
    ...
    def start_exam_attempt(self, user: dict, exam_id: str, verified_face: Optional[str] = None) -> Dict[str, Any]:
        ...
        # Biometric verification check removed per simplified exam configuration
        if verified_face and not enrolled_face:
            # Save face reference if student does not have one yet
